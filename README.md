...
- Run `npm start`, the page will automatically load on localhost:8080 if you don't setup the `.env` file.
...
Feel free to check the [issues page](https://github.com/Theophile-Kango/simple_node_website/issues)
## Show your support
